...
export async function findListByListNumber(
  listNumber: number
...
export async function findListAuthorsByListNumber(listNumber: number) {
...
export async function findPopulatedListByListNumber(
  listNumber: number
...
export async function findFullyPopulatedListByListNumber(
  listNumber: number
...
export async function findAllListsForLanguage(
...
export async function findLatestListNumber(): Promise<number> {
...
export async function createList(
  ...
  const newListNumber = await findLatestListNumber();
  const newList = {
    ...newListData,
    _id: newListId,
...
export async function addUnitToList(listNumber: number, unitName: string) {
  const listResponse = await findListByListNumber(listNumber);
