...
export default function UserMenu({ user }: UserMenuProps) {
  ...
  return (
    <>
      {/* Visible on desktop */}
      <div className="m-4 hidden h-[60px] w-[60px] select-none rounded-full bg-slate-200 md:block md:h-[50px] md:w-[50px]">
        {user.image && (
          <Image
            src={user.image}
      ...
      {/* Visible on mobile */}
      <div className="m-4 h-[60px] w-[60px] select-none rounded-full bg-slate-200 md:hidden md:h-[50px] md:w-[50px]">
        {user.image && (
          <Image
            src={user.image}
            alt="User profile image"
