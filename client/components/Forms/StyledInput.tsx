...
const StyledInput = forwardRef<HTMLInputElement, StyledInputProps>(function (
  {
    label,
    optional,
    id,
  ...
  return (
    ...
    >
      ...
      <Label
        htmlFor={id}
        className={cn(
          "font-sans absolute -top-6 left-0 text-base text-grey-800 transition-all duration-75 peer-placeholder-shown:top-3 peer-placeholder-shown:px-4 peer-placeholder-shown:text-cmdr peer-placeholder-shown:text-grey-800",
