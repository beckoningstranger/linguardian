...
export default function EditOrCreateItemForm({
  ...
  const onSubmit = async (data: ItemWithPopulatedTranslations) => {
    ...
    if (isNewItem) {
      ...
      // It's important that we submit ALL translations, also
      // languages that the user didn't look at, but at the moment the form
      // never gets that data because we filter it out on page.tsx. PROBLEM!
