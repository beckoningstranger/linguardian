    ...
    audio: z
        .array(
            z
                ...
                .max(
                    80,
                    "URLs to audio files can be no longer than 80 characters"
                )
        )
        .optional(),
    pics: z
        .array(
            z
                ...
                .max(
                    80,
                    "URLs to image files can be no longer than 80 characters"
                )
        )
        .optional(),
    vids: z
        .array(
            z
                ...
                .max(
                    80,
                    "URLs to video files can be no longer than 80 characters"
                )
        )
        .optional(),
    IPA: z
        .array(
            z
                ...
                .max(
                    50,
                    "IPA transcriptions can be no longer than 50 characters"
                )
        )
        .optional(),
    tags: tagSchema
...
export const findItemsByQueryParamsSchema = z.object({
...
export type SearchDictionaryParams = z.infer<
    typeof findItemsByQueryParamsSchema
>;
export type AlternativeAnswers = z.infer<typeof alternativeAnswersSchema>;
export type PromptHelpers = z.infer<typeof promptHelpersSchema>;
